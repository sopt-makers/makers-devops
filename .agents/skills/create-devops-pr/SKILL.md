...
- 그룹 디렉토리 자체가 무엇인지 불분명하면 사용자에게 확인한다
...
변경의 성격을 파악해 type을 결정한다. 확신이 없으면 사용자에게 물어본다.

### Step 4: PR 제목과 description 초안 작성

변경 내용을 분석하여:

1. 제목 초안을 `<type> [<scope>]: <description>` 형식으로 작성
2. description의 bullet point 목록을 작성

**사용자에게 초안을 먼저 보여주고 확인을 받은 뒤 PR을 생성한다.**

### Step 5: PR 생성

사용자가 확인하면 `gh` CLI로 PR을 생성한다.
